...
argument-hint: "[issue] [--type bug|build|performance|deployment] [--trace]"
---

# /develop:troubleshoot - Issue Diagnosis and Resolution
...
## Usage
```
/develop:troubleshoot [issue] [--type bug|build|performance|deployment] [--trace]
```
