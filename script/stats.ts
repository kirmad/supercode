...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/kirmad/supercode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for kirmad/supercode...\n")
...
console.log("Fetching npm all-time downloads for @kirmad/supercode...\n")
const npmDownloads = await fetchNpmDownloads("@kirmad/supercode")
