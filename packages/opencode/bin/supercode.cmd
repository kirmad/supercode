...
set "name=@kirmad/supercode-!platform!-!arch!"
set "binary=supercode.exe"
...
:not_found
echo It seems that your package manager failed to install the right version of the supercode CLI for your platform. You can try manually installing the "%name%" package >&2
exit /b 1
