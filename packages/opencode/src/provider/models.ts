...
export namespace ModelsDev {
  ...
  function getGitHubCopilotModelOverrides(): Record<string, { output: number; contextWindow: number; input?: number; name?: string }> {
    return {
      ...
      "claude-sonnet-4": { output: 16000, contextWindow: 144_000, input: 128_000, name: "Claude Sonnet 4 - 1x" },
      "claude-sonnet-4.5": { output: 16000, contextWindow: 144_000, input: 128_000, name: "Claude Sonnet 4.5 - 1x" },
