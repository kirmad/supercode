...
# /develop:design - System and Component Design
...
## Usage
```
/develop:design [target] [--type architecture|api|component|database] [--format diagram|spec|code]
```
