...
# /develop:implement - Feature Implementation
...
## Usage
```
/develop:implement [feature-description] [--type component|api|service|feature] [--framework react|vue|express|etc] [--safe]
```
