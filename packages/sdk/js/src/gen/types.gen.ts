...
export type EventDebugLogsEntry = {
  type: "debug_logs.entry"
  properties:
    | {
        id: string
...
export type WebChatResponse = WebChatResponses[keyof WebChatResponses]
...
export type DebugLogsGetAllData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type DebugLogsGetAllResponses = {
  /**
   * All debug logs
   */
  200: {
...
export type DebugLogsGetAllResponse = DebugLogsGetAllResponses[keyof DebugLogsGetAllResponses]

export type DebugLogsClearSessionData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type DebugLogsClearSessionResponses = {
  /**
   * Successfully cleared session debug logs
   */
  200: boolean
}

export type DebugLogsClearSessionResponse = DebugLogsClearSessionResponses[keyof DebugLogsClearSessionResponses]

export type DebugLogsGetSessionData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type DebugLogsGetSessionResponses = {
  /**
   * Session debug logs
   */
  200: Array<
...
export type DebugLogsGetSessionResponse = DebugLogsGetSessionResponses[keyof DebugLogsGetSessionResponses]

export type HttpLogsClearAllData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type HttpLogsClearAllResponses = {
  /**
   * Successfully cleared all HTTP logs
   */
  200: boolean
}

export type HttpLogsClearAllResponse = HttpLogsClearAllResponses[keyof HttpLogsClearAllResponses]

export type HttpLogsGetAllData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type HttpLogsGetAllResponses = {
  /**
   * All HTTP logs
   */
  200: Array<{
...
export type HttpLogsGetAllResponse = HttpLogsGetAllResponses[keyof HttpLogsGetAllResponses]

export type HttpLogsGetSessionData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type HttpLogsGetSessionResponses = {
  /**
   * Session HTTP logs
   */
  200: Array<{
...
export type HttpLogsGetSessionResponse = HttpLogsGetSessionResponses[keyof HttpLogsGetSessionResponses]
